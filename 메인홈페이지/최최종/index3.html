  ...
  <div class="container">
    <header class="header">
      ...
      <div class="nav">
        <ul>
          ...
          <li><a href="#">공지사항</a></li>
          <li><a href="index3.html" id="now">수상내역</a></li>
          <li><a href="index2.html">동아리 소개</a></li>
    ...
    <div class="wrap">
      ...
      <section id="contents">
        ...
        <br>
        <br>
        <img src="./award1.jpg" alt="awards" width=60% >
        <p>세종대학교 제 2회 창의융합노마드 융합아이디어 학술제 우수상</p>
        <br>
        <img src="./award2.jpg" alt="awards" width=60% >
        <p>세종대학교 제 4회 SW·해커톤 은상</p>
        <br>
        <img src="./award3.jpg" alt="awards" width=60% >
        <p>세종대학교 제 5회 SW·해커톤 은상</p>
        <br>
        <img src="./award4.jpg" alt="awards" width=60% >
        <p>세종대학교 제 7회 SW·인공지능 해커톤 장려상</p>
        <br>
        <img src="./award5.jpg" alt="awards" width=60% >
